...
qq.maps.event.addDomListener(btnSearch, 'click', function () {
    ...
    url = encodeURI("http://apis.map.qq.com/ws/place/v1/search?keyword=" + value + "&boundary=region(" + query_city + ",0)&page_size=9&page_index=1&key=PAZBZ-LUI3U-7I3VV-4RTTQ-GTX52-ZQFR5&output=jsonp&&callback=?");
