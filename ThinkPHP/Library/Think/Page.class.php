...
class Page{
    ...
    public function showHome() {
        ...
        $the_end = '<a href="' . $this->url($this->totalPages) . '">尾页</a><input type="text" id="page_num" class="fy_ss" value="' . $this->nowPage . '"><input type="button" onclick="page_jump();" id="tz_page" class="fy_an" value="确定">';//跳转样式
