 ...
 */
class MatchTypeModel extends Model{

    protected $_validate = array(
         array('title', 'require', '分类标题不能为空!', self::EXISTS_VALIDATE, 'regex', self::MODEL_BOTH),
		 array('deadline', 'require', '截止时间不能为空!', self::EXISTS_VALIDATE, 'regex', self::MODEL_BOTH),
    );
    ...
    protected $_auto = array(
		...
		array('deadline','jztimes','3','callback'),
		//array('china','listbrand','3','callback'),
    );
    ...
    public function update(){
        ...
        //记录行为
        action_log('update_category', 'producttype', $data['id'] ? $data['id'] : $res, UID);
	...
	protected function jztimes(){

		$jztimes = strtotime($_POST['deadline']);
	    return $jztimes;
	}
