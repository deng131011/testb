    ...
    public function add($username = '', $password = '', $repassword = '', $email = ''){
        if(IS_POST){
            ...
            if(0 < $uid){ //注册成功
                ...
                $user = array('uid' => $uid, 'nickname' => $username, 'status' => 1,'icon' => $_POST['icon'],'flag' => $flag,'sort' => $_POST['sort'],'content' => $_POST['content']);
	...
	public function edit(){
		if(IS_POST){
			...
			if(empty($_POST['username'])){
				...
				$result = $nick->execute("update bhy_member set nickname='".$_POST['nickname']."',asknum='".$_POST['asknum']."', replynum='".$_POST['replynum']."',icon=".$_POST['icon'].",sort=".$_POST['sort'].",content='".$_POST['content']."' where uid=".$_POST['id']);
