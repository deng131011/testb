	...
	public function forms(){
		...
		if(IS_POST){
			...
			if(!empty($resuinfo)){
				...
				//判断是否为同一个电话号码
				$tyu[mobile] = $pt[mobile];
				$tyuinfo = M('match_person')->where($tyu)->find();
				if(!empty($tyuinfo)){
					session('match_person_id',$tyuinfo[id]);//存入session
