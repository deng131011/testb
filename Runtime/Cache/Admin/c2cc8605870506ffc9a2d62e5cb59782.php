		...
		<dt class="cf">
			<form action="<?php echo U('edit');?>" method="post">
				<div class="btn-toolbar opt-btn cf">
					...
					<?php if($list[pagetype] == 2): ?><a title="文章" href="javascript:;" style="color:#999999;">文章</a>
					<?php elseif($list[pagetype] == 3): ?>
					<a title="视频" href="<?php echo U('Invest/index',array('typeid'=>$list['id']));?>">视频</a><?php endif; ?>
				...
				<div class="name">
					...
					<?php if($list['isnav'] == 2): ?><font style="color:red;">隐</font><?php endif; ?>
					<span class="help-inline msg"></span>
				</div>
			</form>
		</dt>
		<?php if(!empty($list['_'])): ?><dd style="display:block;">
